...
# Result: 0.5
  ...
  `,e}const a="/SmoothMath-Docs",b={[`${a}/`]:c,[`${a}/installation`]:d,[`${a}/usage`]:p,[`${a}/reference`]:m,[`${a}/contributing`]:f,[`${a}/downloads`]:g};function y(e){history.pushState(null,"",e),l()}function l(){const e=document.querySelector("#app"),o=b[window.location.pathname]||c;e.innerHTML="",e.appendChild(h()),e.appendChild(o()),e.appendChild(u()),v()}function v(){document.querySelectorAll("[data-link]").forEach(o=>{o.addEventListener("click",r=>{r.preventDefault();const i=r.target;y(i.href)})})}document.addEventListener("DOMContentLoaded",()=>{l(),window.addEventListener("popstate",l)});
